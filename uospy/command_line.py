...
def cluos():
    parser = argparse.ArgumentParser(description='Command Line Interface to UOSIO via python')
    parser.add_argument('--api-version','-v', type=str, default='v1', action='store', dest='api_version')
    parser.add_argument('--url', '-u', type=str, action='store', default='https://api.uosnewyork.io', dest='url')
    ...
    newacct_parser.add_argument('--stake-net', type=str, action='store', default='1.0000 UOS', dest='stake_net')
    newacct_parser.add_argument('--stake-cpu', type=str, action='store', default='1.0000 UOS', dest='stake_cpu')
    ...
    # 
    # connect 
    ce = Cluos(url=args.url, version=args.api_version)
